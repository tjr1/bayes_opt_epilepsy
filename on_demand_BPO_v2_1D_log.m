function varargout = on_demand_BPO_v2_1D_log(varargin)
% ON_DEMAND_BPO_V2_1D_LOG MATLAB code for on_demand_BPO_v2_1D_log.fig
%      ON_DEMAND_BPO_V2_1D_LOG, by itself, creates a new ON_DEMAND_BPO_V2_1D_LOG or raises the existing
%      singleton*.
%
%      H = ON_DEMAND_BPO_V2_1D_LOG returns the handle to a new ON_DEMAND_BPO_V2_1D_LOG or the handle to
%      the existing singleton*.
%
%      ON_DEMAND_BPO_V2_1D_LOG('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ON_DEMAND_BPO_V2_1D_LOG.M with the given input arguments.
%
%      ON_DEMAND_BPO_V2_1D_LOG('Property','Value',...) creates a new ON_DEMAND_BPO_V2_1D_LOG or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before on_demand_BPO_v2_1D_log_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to on_demand_BPO_v2_1D_log_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @on_demand_BPO_v2_1D_log_OpeningFcn, ...
                   'gui_OutputFcn',  @on_demand_BPO_v2_1D_log_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before on_demand_BPO_v2_1D_log is made visible.
function on_demand_BPO_v2_1D_log_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to on_demand_BPO_v2_1D_log (see VARARGIN)

% Choose default command line output for on_demand_BPO_v2_1D_log
...
% UIWAIT makes on_demand_BPO_v2_1D_log wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = on_demand_BPO_v2_1D_log_OutputFcn(hObject, eventdata, handles) 
